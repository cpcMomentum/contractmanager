...
/**
 * „Was ist neu?"-Fenster (Baustein 0b, Rollout aus dem Pilot RechnungsWerk#308).
 *
 ...
 *
 * Uebernommen aus dem Pilot, Zeile fuer Zeile: die Vorlage haelt bewusst keine
 * App-Besonderheiten, damit alle fuenf Apps dasselbe Verhalten zeigen. Was hier
 * abweicht, weicht auch im Verhalten ab — also nichts.
 */
class WhatsNewService {
	 ...
	 * gesetzt von {@see \OCA\ContractManager\Migration\WhatsNewBootstrap}.
