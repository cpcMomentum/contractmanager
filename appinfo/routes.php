...
return [
    'routes' => [
        ...
        ['name' => 'contract#searchUsers', 'url' => '/api/contracts/users/search', 'verb' => 'GET'],
        ['name' => 'contract#transferPreview', 'url' => '/api/contracts/transfer-preview', 'verb' => 'GET'],
        ['name' => 'contract#transfer', 'url' => '/api/contracts/transfer', 'verb' => 'POST'],
